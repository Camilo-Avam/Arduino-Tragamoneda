...
BLEStringCharacteristic characteristicBLE_cashOut("9d0983d4-0c64-45c4-b83b-14abaa6ba18b", BLERead | BLEWrite, 1024);
...
WebServer server(80);
String backendURL = "http://192.168.10.83:8000/";
...
void setup() {
  ...
  serviceBLE.addCharacteristic(characteristicBLE_cashOut);
  ...
  characteristicBLE_cashOut.writeValue("false");
